...
// * @since       SPEC version
// * @version 
// * 2020/07/02 彥仲 202007070141-00 修正chrome瀏覽器無法退貨取消的狀況
// ************************************************************/
  try {
...
<tr align='center' bgcolor='#ffffff'  height="25">
  ...
  <% //下方的if判斷條件中加入判斷卡別(CARD_TYPE)是否為 C - CUP, 若不為C - CUP才可以秀出checkbox 
     //Merchant Console 線上取消作業模組  修改  by Jimmy Kang 20150511 %>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#D8D8D8">
    ...
    <tr bgcolor='#ffffff' height="25">
      <td align='left' width='15%'>可取消退貨金額</td>

...
try{
  //  ***************************************************************************
  //  * #File Name: 	 Merchant_ChangePwd.jsp
  ...
  //  * @version	 0.0.1    2007-09-26    Caspar Chen
  //  ***************************************************************************
  //  * 異動說明
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor='#D8D8D8'>
  ...
  <tr align='center' height="30">
   <td align='center' bgcolor='#F4F4FF' colspan="2">
    ...
    <input type="reset" value='清除畫面' name='btnClear' id='btnClear' onclick=document.form.oldPwd.focus(); autocomplete="off">
   </td>
  </tr>
 </table>
 <%
